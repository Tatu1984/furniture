...
export default function EditProjectPage() {
  ...
  React.useEffect(() => {
    async function fetchProject() {
      try {
        ...
        setMedia(
          data.media.map((m: { url: string; type: string; caption: string | null }) => ({
            url: m.url,
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Edit Project" description="Update project details and media" />
          ...
          <CardContent className="space-y-4">
            {media.length === 0 ? (
              <p className="text-center text-sm text-muted-foreground py-4">
                No media added. Click "Add Media" to add images or videos.
              </p>
            ) : (
